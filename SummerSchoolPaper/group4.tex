...
This section summarizes the four main groups of problems and challenges identified

-Graphics
-SPSS syntax designed for different purpose
-Confusing elements
-Rounding and finding results
-Amount of output
