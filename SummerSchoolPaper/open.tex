...
In other cases we have constructed virtual machines to recompute experiments.  
We also built a machine which not only contains a clone of the github repository, but all the necessary software and packages such as R, \LaTeX to build the paper.
...
many computations involved in constructing the data must be run by hand.  Also some of the tables in this paper are static, with data entered manually rather than reanalysed by Sweave. This constrasts negatively with Brown's executable paper, \cite{brown}.  
...
\textbf{Put in links somewhere to VMS and recomputation.org?}.
